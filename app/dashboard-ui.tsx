  ...
  return (
    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
       ...
       <PermissionGuard permission="priority_booking" fallback={
         <Card className="relative overflow-hidden opacity-75">
           <CardHeader>
              ...
              <CardDescription>Upgrade to access priority booking.</CardDescription>
           </CardHeader>
          <CardContent>
           ...
           <CardFooter>
              <Button disabled variant="outline">
                Upgrade Required <Zap className="ml-2 h-4 w-4" />
              </Button>
           </CardFooter>
        </Card>
       }>
         <Card className="relative overflow-hidden">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">Get expert guidance from a real coach with priority booking.</p>
          </CardContent>
           <CardFooter>
              <Button asChild>
                <Link href="/sos">
