    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        userProfileData = {
          ...
          avatar: firebaseUser.photoURL || `https://placehold.co/128x128.png?text=${(firebaseUser.displayName || 'S').charAt(0)}`,
      ...
      userProfileData.subscriptionTier = (claims.subscriptionTier as SubscriptionTierType | 'admin') || 'Explorer';
